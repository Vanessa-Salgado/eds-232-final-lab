...
```
```{r}
xgb_best = show_best(xgb_cv_tune, n = 1, metric = "rmse") #get metrics for best boosted regression
xgb_best
```
...
#testing accuracy
accuracy(test_predict_xgb, truth = dic, estimate = .pred) #get accuracy of testing prediction
